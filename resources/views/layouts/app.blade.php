...
<head>
    ...
    <title>Sistem Informasi Penjadwalan Sekolah</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="{{ asset('plugins/fontawesome-free/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('plugins/toastr/toastr.min.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/css/adminlte.min.css') }}">
    <link rel="shrotcut icon" href="{{ asset('img/smkn2cilaku.png') }}">
</head>
...
<body class="hold-transition login-page"
    ...
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('img/smkda.png') }}" width="100%" alt="">
        </div>
        ...
        <footer style="color: white;">
            <marquee>
                <strong>Copyright &copy;
                    ...
                    </script> &diams; <a href="" style="color: white;">SMK
                        Negeri 2 Cilaku</a>.
                </strong>
            </marquee>
        </footer>
    ...
    @error('id_card')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Guru SMKN 2 Cilaku!");
        </script>
    @enderror
    @error('guru')
        <script>
    ...
    @error('no_induk')
        <script>
            toastr.error("Maaf User ini tidak terdaftar sebagai Siswa SMKN 2 Cilaku!");
        </script>
    @enderror
    @error('siswa')
        <script>
